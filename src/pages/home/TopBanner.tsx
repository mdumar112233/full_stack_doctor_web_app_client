      ...
      <div className="w-[90%] xm:w-[80%] mx-auto mb-20 -mt-48">
        <div className="grid grid-flow-row tablet:grid-cols-3 grid-cols-1 gap-10">
            <div className="shadow-md h-80 bg-white rounded-2xl p-8">
                ...
                <h3 className="text-main-color font-bold tablet:text-xl xl:text-2xl text-2xl mb-3">Online Appoinment</h3>
                <p className="text-[#6F8BA4] text-sm lg:leading-normal xl:leading-7">Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore, neque.</p>
                <button className="text-white font-bold bg-main-color py-3 px-5 rounded-3xl tablet:text-xs xl:text-sm text-sm mt-5 hover:bg-pink-color transition-all">MAKE A APPOINMENT</button>
            </div>

            <div className="shadow-md h-80 bg-white rounded-2xl p-8">
                <BiTimeFive className="text-main-color" size={45}/>
                <p className="text-[#6F8BA4] mt-4">Timing schedule</p>
                <h3 className="text-main-color font-bold tablet:text-xl xl:text-2xl text-2xl mb-3">Working Hours</h3>
            ...
            <div className="shadow-md h-80 bg-white rounded-2xl p-8">
                ...
                <h3 className="text-main-color font-bold tablet:text-xl xl:text-2xl text-2xl  mb-3">1-800-600-3922</h3>
                <p className="text-[#6F8BA4] text-sm leading-7">Lorem ipsum dolor sit amet consectetur adipi elit. Labore, neque. consectetur adipisicing elit. Labore, neque.</p>
            </div>
        </div>
      </div>
    </section>
